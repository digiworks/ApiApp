...
sudo apt install apache2 build-essential curl git python libglib2.0-dev php php-dev php-intl php-curl php-mbstring php-bcmath php-common php-pgsql php-mysql php-bz2 php-gd composer 
